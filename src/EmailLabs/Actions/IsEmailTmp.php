...
class IsEmailTmp extends EmailLabsRequestLayer
{
     ...
     */
    protected $action = 'is_mail_tmp/email/';
     ...
     */
    public function getAction(){ return $this->action.$this->email; }
    ...
    public function getResult(){
        try{
            ...
            EmailLabsErrorHandler::setError( __CLASS__, 'Error', "Email is require for this method, use ->setEmail( 'email@adress' )" );
        }
    }
}